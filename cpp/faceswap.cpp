...
SwapFace::SwapFace(string model_path, std::string matrixpath) {
    ...
    for (int i = 0; i < numInputNodes; i++) {
        ...
        std::cerr << "SwapFace input name: " << input_name_Ptr.get() << std::endl;
    ...
    for (int i = 0; i < numOutputNodes; i++) {
        ...
        std::cerr << "SwapFace output name: " << output_name_Ptr.get() << std::endl;
    ...
    FILE *fp = fopen(matrixpath.c_str(), "rb");
